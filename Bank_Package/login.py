...
class Login():
    ...
    def main_frame(self):
        ...
        self.remember_me_checkbox = Checkbutton(self.f, text="Remember Me", variable=Bank.remember_me, bg='#777777', font=('Times','12','bold'), fg='#123456')
        self.remember_me_checkbox.grid(row=3, column=1)
        ...
        self.b1.grid(row=5,column=0,columnspan=4,padx=19,pady=31)
    ...
    def login(self,event=None):
        ...
        RememberMe = Bank.remember_me.get()
